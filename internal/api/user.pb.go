...
const file_api_user_proto_rawDesc = "" +
	"\n" +
	"\x0eapi/user.proto\x12\x03api\x1a\x1cgoogle/api/annotations.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"{\n" +
	"\x04User\x12\x0e\n" +
	...
	"\x04user\x18\x01 \x01(\v2\t.api.UserR\x04user2\xaa\x01\n" +
	"\vUserService\x12P\n" +
	"\n" +
	"CreateUser\x12\x16.api.CreateUserRequest\x1a\x17.api.CreateUserResponse\"\x11\x82\xd3\xe4\x93\x02\v:\x01*\"\x06/users\x12I\n" +
	"\aGetUser\x12\x13.api.GetUserRequest\x1a\x14.api.GetUserResponse\"\x13\x82\xd3\xe4\x93\x02\r\x12\v/users/{id}Bz\n" +
	"\acom.apiB\tUserProtoP\x01Z8github.com/Romasmi/s-shop-microservices/internal/api;api\xa2\x02\x03AXX\xaa\x02\x03Api\xca\x02\x03Api\xe2\x02\x0fApi\\GPBMetadata\xea\x02\x03Apib\x06proto3"
...
var file_api_user_proto_depIdxs = []int32{
	...
	0, // 2: api.GetUserResponse.user:type_name -> api.User
	1, // 3: api.UserService.CreateUser:input_type -> api.CreateUserRequest
	3, // 4: api.UserService.GetUser:input_type -> api.GetUserRequest
	2, // 5: api.UserService.CreateUser:output_type -> api.CreateUserResponse
	4, // 6: api.UserService.GetUser:output_type -> api.GetUserResponse
