...
import (
	...
	http2 "github.com/Romasmi/s-shop-microservices/internal/transport/http"
...
func RegisterRoutes(
	...
	router.HandleFunc("/health", func(w http.ResponseWriter, r *http.Request) {
		http2.SuccessJsonResponse(w, map[string]string{"status": "OK"})
...
func NotFoundHandler(w http.ResponseWriter, r *http.Request) {
	http2.JsonError(w, http.StatusNotFound, fmt.Errorf("undefined route"))
}

func MethodNotAllowedHandler(w http.ResponseWriter, r *http.Request) {
	http2.JsonError(w, http.StatusMethodNotAllowed, fmt.Errorf("method not allowed"))
}
