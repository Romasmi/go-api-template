...
- *Rule*: Always use `option go_package = "github.com/Romasmi/s-shop-microservices/internal/api;api";`.

## 2. Code Generation
- Tool: `buf`.
- Command: `make generate`.
- Output: `internal/api/` (for Go code) and `api/swagger/` (for Swagger JSON).
- *Rule*: Never edit files in `internal/api/` manually.
